...
import { Mail, ArrowLeft, Send, CheckCircle2, AlertCircle, LifeBuoy } from 'lucide-react';
        ...
        {!enviado ? (
          <div className="relative z-10">
            <div className="mb-10 text-center">
              <h2 className="text-3xl font-black text-gray-800 uppercase italic tracking-tighter mb-2">Esqueceu a Senha?</h2>
              <p className="text-gray-400 text-xs font-bold uppercase tracking-widest leading-relaxed">
                Insira seu e-mail para receber as <br/> instruções de recuperação.
              </p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-4">E-mail Cadastrado</label>
              ...
              >
                {loading ? "Enviando..." : (
                  <span className="flex items-center gap-2">Enviar Link <Send size={16} /></span>
                )}
              </Button>
            </form>
          </div>
          ...
          <div className="text-center py-6 relative z-10 animate-in zoom-in-95 duration-300">
            ...
            <h3 className="text-2xl font-black text-gray-800 uppercase italic tracking-tighter mb-4">E-mail Enviado!</h3>
            <p className="text-gray-400 text-[11px] font-bold uppercase tracking-widest leading-relaxed mb-8">
              Verifique sua caixa de entrada e siga as <br/> instruções para redefinir sua senha.
            </p>
            <Link to="/login">
              <Button variant="outline" className="w-full h-12 rounded-xl border-gray-100 font-black uppercase italic text-gray-400 hover:text-orange-500 transition-all">
