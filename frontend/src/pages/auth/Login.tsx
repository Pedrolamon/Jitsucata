          ...
          <CardContent className="grid p-0 md:grid-cols-2">
            <form className="p-6 md:p-8" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-6">
                ...
                {error && (
                  <div className="text-sm text-center text-red-500 bg-red-50 p-3 rounded">
                    {error}
                  </div>
                )}
                ...
                <div className="text-center text-sm">
                  Não tem uma conta?
                  {" "}
                  <a href="/register" className="underline underline-offset-4 font-medium hover:text-primary">
                    Registre-se
                  </a>
                </div>
              </div>
            ...
            <div className="hidden items-center justify-center md:flex">
              <Link to="/" className="flex items-center gap-2 group">
                <span className="font-black text-2xl tracking-tighter uppercase italic text-[var(--color-primary-dark)]">
                  Jit<span className="text-gray-600">Sucata</span>
                </span>
              </Link>
            </div>
          </CardContent>
