...
LegalRepresentative: {
  ...
  return (
  <div className={cn("flex min-h-screen min-w-screen items-center justify-center p-4 bg-gray-50 dark:bg-gray-900 font-sans")}>
                ...
                <div className=" gap-6 grid md:grid-cols-2">
                  ...
                  <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, EnvironmentalLicense:{...formData.EnvironmentalLicense, numero:e.target.value}})}
                    />
                  </div>
                  <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, EnvironmentalLicense:{...formData.EnvironmentalLicense, IssuingBody:e.target.value}})}
                    />
                  </div>
                  <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, EnvironmentalLicense:{...formData.EnvironmentalLicense, validity:e.target.value}})}
                    />
                  </div>
                  </div>
                  
                  <div className='m-4 border-b pb-2 flex justify-center  '>
                    <h2 className='text-xl font-semibold text-slate-800 tracking-tight'>Informações do representante legal</h2>
                  </div>
                  ...
                  <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, LegalRepresentative:{...formData.LegalRepresentative, name:e.target.value}})}
                    />
                  </div>
                   <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, LegalRepresentative:{...formData.LegalRepresentative, cpf:e.target.value}})}
                    />
                  </div>
                   <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, LegalRepresentative:{...formData.LegalRepresentative, position:e.target.value}})}
                    />
                  </div>
                   <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, LegalRepresentative:{...formData.LegalRepresentative, phone:e.target.value}})}
                    />
                  </div>
                  <div className="grid gap-3">
                    ...
                    <Input
                      ...
                      onChange={(e) => setFormData({...formData, LegalRepresentative:{...formData.LegalRepresentative, email:e.target.value}})}
                    />
                  </div>
                  </div>
