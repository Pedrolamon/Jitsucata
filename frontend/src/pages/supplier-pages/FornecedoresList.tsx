            ...
            <tbody className="bg-white divide-y divide-gray-100">
              {filteredFornecedores.map((f) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-3 py-1 text-[10px] font-black rounded-full uppercase ${f.status ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                    >
...
>>>>>>> 67748c1f5223b794bc71d6873e60be11a17a78f2
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedFornecedor.legalNature}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-[10px] uppercase font-bold">
                    ...
                    <p className="font-medium">{selectedFornecedor.capacity}</p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-[10px] uppercase font-bold">
                      Insc. Estadual
                    ...
                    <p className="font-medium">
                      {selectedFornecedor.stateRegistration || "Não informado"}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-400 text-[10px] uppercase font-bold">
                    ...
                    <p className="font-medium">{selectedFornecedor.Phone}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm space-y-1 text-gray-700">
                  <p>
                    <strong>Rua:</strong> {selectedFornecedor.address.street},{" "}
                    {selectedFornecedor.address.number}
                  </p>
                  <p>
                    <strong>Bairro:</strong>{" "}
                    {selectedFornecedor.address.neighborhood}
                  </p>
                  <p>
                    <strong>Cidade/UF:</strong>{" "}
                    {selectedFornecedor.address.city} -{" "}
                    {selectedFornecedor.address.state}
                  </p>
                  <p>
                    <strong>CEP:</strong> {selectedFornecedor.address.cep}
                  </p>
                  {selectedFornecedor.address.complement && (
                    <p className="text-gray-500 italic text-xs">
                      Obs: {selectedFornecedor.address.complement}
                    </p>
                  )}
                </div>
              </div>
                ...
                <div className="text-sm space-y-2">
                  <div>
                    ...
                    <p className="font-bold text-blue-900">
                      {selectedFornecedor.EnvironmentalLicense.numero}
                    </p>
                  </div>
                  <div className="flex justify-between">
                    <div>
                      ...
                      <p className="font-medium">
                        {selectedFornecedor.EnvironmentalLicense.IssuingBody}
                      </p>
                    </div>
                    <div>
                      <p className="text-blue-400 text-[10px] uppercase font-bold">
                      ...
                      <p className="font-bold text-red-600">
                        {selectedFornecedor.EnvironmentalLicense.validity}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4 bg-gray-50 p-4 rounded-xl border border-gray-200">
                ...
                <div className="text-sm space-y-2">
                  <p className="font-bold text-gray-900 leading-none">
                    {selectedFornecedor.LegalRepresentative.name}
                  </p>
                  <p className="text-xs text-gray-500 italic">
                    {selectedFornecedor.LegalRepresentative.position}
                  </p>
                  <div className="grid grid-cols-2 gap-2 mt-2 pt-2 border-t border-gray-200">
                    <div>
                      ...
                      <p className="text-xs">
                        {selectedFornecedor.LegalRepresentative.cpf}
                      </p>
                    </div>
                    <div>
                      <p className="text-gray-400 text-[10px] uppercase font-bold">
                      ...
                      <p className="text-xs">
                        {selectedFornecedor.LegalRepresentative.phone}
                      </p>
                    </div>
                  </div>
                </div>
