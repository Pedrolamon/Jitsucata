...
const Aprovar = () => {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto min-h-screen">
      <div className="mb-8">
        <button onClick={() => navigate(-1)} className="text-[var(--color-primary)] hover:opacity-80 flex items-center gap-2 mb-4">
              ...
              <CardContent className="p-0">
                ...
                <div className="p-6 flex flex-col md:flex-row justify-between items-center gap-6 bg-white">
                  ...
                  <div className="flex gap-3 w-full md:w-auto">
                    <Button
                      variant="outline"
                      className="flex-1 md:flex-none border-red-300 text-red-600 hover:text-red-400 !border-none"
                    ...
                    <Button
                      className="flex-1 md:flex-none  hover:text-emerald-500 text-emerald-700 font-bold !border-none"
